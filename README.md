...
I'm currently learning how to extract Next.js's cache to external replicable in-memory database in order to enable self-hosted instances of Next.js projects to be hosted in [Kubernetes](https://kubernetes.io/) clusters.
